package com.example.user.calculater;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        info= findViewById(R.id.Ask);
        result=findViewById(R.id.Ancwer);

        ans = (TextView) findViewById(R.id.Ancwer);
